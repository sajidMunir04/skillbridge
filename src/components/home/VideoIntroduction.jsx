    ...
    return (
        <div className={styles.container}>
            <div className={styles.videoContainer}>
                <img className={styles.videoImg}  src={process.env.PUBLIC_URL+'/images/Container(2).png'} alt='an image'/>
            </div>
            <div className={styles.videoButtons} onMouseEnter={() => {setHoverState(true)}} 
            onMouseLeave={() => {setHoverState(false)}}>
                <img className={combinedClassNames} src={process.env.PUBLIC_URL+'/images/Button.png'} alt='an image'/>
            </div>
        </div>
    );
}
